...
def selects_user_names_and_amounts_of_all_pledges_grouped_by_name_then_orders_them_by_the_summed_amount
  "SELECT Users.name, SUM (Pledges.amount) AS total_pledges FROM Users INNER JOIN Pledges ON Users.id = Pledges.User_id GROUP BY Users.name ORDER BY total_pledges ASC"
end
